// code/main_no_simd.cpp — Monster Spawning Grid simulator
//
// Variant: SCALAR cell-by-cell neighbour counting, 8 THREADS.
//
// The bit-plane representation is kept (same I/O, same BitGrid), but the
// step kernel uses get_bit() to walk the 24 neighbours one at a time instead
// of the word-level CSA/shift SIMD path.  Eight threads each own a contiguous
// band of rows, identical to the threading arrangement in main.cpp.
//
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// step — advance the entire grid by one generation (8 threads, scalar kernel)
// ─────────────────────────────────────────────────────────────────────────────
